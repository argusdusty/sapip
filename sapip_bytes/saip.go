...
func (Q *SAIPQueue) DumpElements() []*PriorityElement {
	Q.lock.Lock()
	defer Q.lock.Unlock()
	return Q.elements.DumpElements()
}

func (Q *SAIPQueue) checkEmpty() bool {
	Q.lock.Lock()
	defer Q.lock.Unlock()
	Q.execLock.Lock()
	defer Q.execLock.Unlock()
...
func (Q *SAIPQueue) checkExecEmpty() bool {
	Q.lock.Lock()
	defer Q.lock.Unlock()
	Q.execLock.Lock()
	defer Q.execLock.Unlock()
...
func (Q *SAIPQueue) checkExec() bool {
	Q.lock.Lock()
	defer Q.lock.Unlock()
